...
$placa = $_GET['placa']; 
$sql = "SELECT us.usu_cedula,us.usu_nombre,us.usu_direccion,us.usu_telefono,vh.veh_placa,vh.veh_marca,vh.veh_modelo,tc.tck_fecha_ingreso,tc.tck_fecha_salida FROM usuario us NATURAL JOIN vehiculo vh NATURAL JOIN ticket tc WHERE vh.veh_placa LIKE concat('$placa','%')";
